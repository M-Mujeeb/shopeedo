...
use App\Http\Controllers\Api\V2\Seller\SupportTicketController;
...
Route::group(['prefix' => 'v2/seller', 'middleware' => ['app_language']], function () {
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::get('orders/pos/{order_id}', 'getPOSInvoice');
        ...
        Route::controller(ShopController::class)->group(function () {
            ...
            Route::get('shop/status', 'get_shop_status')->name('seller.shop.get.status');
