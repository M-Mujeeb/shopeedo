...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller',  'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(InvoiceController::class)->group(function () {
        ...
        Route::get('/invoice/{order_id}/mini', 'invoice_download_mini')->name('invoice.download.mini');
    });
    ...
    Route::controller(ShopController::class)->group(function () {
        ...
        Route::get('/privacy', 'privacy_policy')->name('seller.privacy_policy');
        Route::post('/shop/status/update', 'shop_status')->name('seller.shop.status');
...
Route::get('seller/privacy', function () {
    return view('seller.shoppedo_seller_terms.privacy_policy');
})->name('seller.privacy_policy');
