...
Route::controller(DeliveryBoyController::class)->group(function () {
    Route::post('/delivery-boy/return-collection/{id}', 'returnCollection')->name('delivery_boy.return_collection');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(PlatformController::class)->group(function () {
        Route::get('/platform-fees', 'index')->name('platform.index');
        Route::post('/platform-fees', 'store')->name('platform.store');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/export-sellers', 'export_sellers')->name('sellers.export-sellers');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/export-customers', 'export_customers')->name('customers.export-customers');
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::post('/business-settings/updateBonuses', 'updateBonuses')->name('business_settings.updateBonuses');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('orders/get-delivery-boys/{order_id}',  'getDeliveryBoys')->name('orders.get-delivery-boys');
