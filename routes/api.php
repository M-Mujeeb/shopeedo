...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    ...
    Route::controller(AuthController::class)->group(function () {
        ...
        Route::post('email-change-verification', 'send_email_change_verification_mail');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('/delivery-boy/order-offers', [DeliveryBoyController::class, 'getPendingOrderOffers'])
    ->middleware('auth:sanctum');
    Route::post('/delivery-boy/order-offer-response', [DeliveryBoyController::class, 'respondToOrderOffer'])
    ->middleware('auth:sanctum');

    Route::post('/seller/info', [ShopController::class, 'storeSellerInfo'])
    ->middleware('auth:sanctum');
    ...
    Route::prefix('delivery-boy')->group(function () {
        Route::controller(DeliveryBoyController::class)->group(function () {
            Route::post('/update-status', 'delivery_boy_status')->name('delivery-boy.status')->middleware('auth:sanctum');
            Route::get('/get-status', 'delivery_boy_get_status')->name('delivery-boy.get.status')->middleware('auth:sanctum');


            Route::get('earning/{id}', 'earning')->middleware('auth:sanctum');

            // Delivery Boy details Api
            Route::get('delivery-boy-detail/{id}', 'deliveryBoyDetails')->middleware('auth:sanctum');
            //Delivery Boy Banner Get
            ...
            Route::get('deliveries/on-going/{id}', 'on_going_delivery')->middleware('auth:sanctum');
            ...
            //Delivery Boy Assigned Order Details
            Route::get('assigned-order-details/{id}',[DeliveryBoyController::class, 'assignedOrderDetails'])->middleware('auth:sanctum');

            //Delivery Boy Earning Graphing Details
            Route::get('earning-details', 'earning_details_graph')->middleware('auth:sanctum');

            Route::get('purchase-history-items/{id}', [DeliveryBoyController::class, 'items'])->middleware('auth:sanctum');
            Route::post('device-info', [DeliveryBoyController::class, 'storeDeviceInfo'])->name('deliveryboy.deviceInfo')->middleware('auth:sanctum');
    ...
    Route::controller(CouponController::class)->group(function () {
        ...
        Route::get('shop-coupon-list/{id}', 'shopCouponList')->middleware('auth:sanctum');
    ...
    Route::get('payment-types', [PaymentTypesController::class, 'getList'])->middleware('auth:sanctum');
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::controller(PurchaseHistoryController::class)->group(function () {
            ...
            Route::post('/rate-delivery-boy', [PurchaseHistoryController::class, 'rateDeliveryBoyStore'])
            ->name('ratings.rateDeliveryBoyStore')->middleware('auth:sanctum');
        });
        ...
        Route::controller(AddressController::class)->middleware('auth:sanctum')->group(function () {
            ...
            Route::get('user/shipping/getAddress/{id}', 'getAddress');
            ...
            Route::get('user/shipping/default_address', 'getShippingAddressDefault');
        ...
        Route::post('payments/pay/wallet', 'App\Http\Controllers\Api\V2\WalletController@process                ')->middleware('auth:sanctum');
        ...
        // bank Alfalah integeration
        Route::post('/payment/alfalah/process', 'App\Http\Controllers\Api\V2\PaymentController@processAlfalahPayment')->middleware('auth:sanctum');
        ...
        Route::post('profile/email-change', 'App\Http\Controllers\Api\V2\ProfileController@updateEmail')->middleware('auth:sanctum');
        Route::get('profile//email-change/callback', 'App\Http\Controllers\Api\V2\ProfileController@email_change_callback')->name('email_change.callback');
    ...
    Route::get('seller/all', 'App\Http\Controllers\Api\V2\SellerController@allSellers');
    ...
    Route::get('products/sub-category/{id}', 'App\Http\Controllers\Api\V2\ProductController@subCategoryProducts')->name('products.subCategoryProducts');
    ...
    Route::get('products/free-shipping', 'App\Http\Controllers\Api\V2\ProductController@freeShipping');
    Route::get('products/popular', 'App\Http\Controllers\Api\V2\ProductController@popular');
    ...
    Route::get('products/live-search', 'App\Http\Controllers\Api\V2\ProductController@liveSearch');
    ...
    // Route::get('getDeliveryBoyDetail/{id}', 'App\Http\Controllers\Api\V2\OrderController@getDeliveryBoy')->name('api.getDeliveryBoyDetail');
    Route::middleware('auth:sanctum')->get('getDeliveryBoyDetail/{id}', 'App\Http\Controllers\Api\V2\OrderController@getDeliveryBoy')->name('api.getDeliveryBoyDetail');
