                        ...
                        <div class="label">Step 2</div>
                                ...
                                <div class="pt-3">
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="{{ route('user.login') }}" class="ml-2 fs-17 fw-400 animate-underline-primary">{{ translate('Log In')}}</a>
                                    </p>
                                </div>
                            </div>
            </div>
            <div class="mt-3 mr-4 mr-md-0">
                            <a href="{{ url()->previous() }}" class="ml-auto fs-17 fw-400 d-flex align-items-center text-primary" style="max-width: fit-content;">
