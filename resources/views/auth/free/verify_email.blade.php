                ...
                <div class="col-xxl-6 col-lg-7">
                    <div class="">
                        <div class="d-md-block d-none overflow-hidden" style="height: 700px" >
                            ...
                            <img src="{{ uploaded_asset(get_setting('password_reset_page_image')) }}" alt="" style="max-width:581px;height: 100%; object-fit: cover; " class="d-md-block d-none rounded-4">
                        </div>
                        ...
                        <div class="row align-items-center justify-content-center justify-content-lg-start h-100">
                            <div class="col-xxl-6 p-4 p-lg-5">
                                ...
                                <div class="pt-3 pt-lg-4 bg-white">
                                    <div class="">
                                        <a href="{{ route('verification.resend') }}" class="btn btn-primary btn-block">{{ translate('Click here to verify email') }}</a>
                                        @if (session('resent'))
