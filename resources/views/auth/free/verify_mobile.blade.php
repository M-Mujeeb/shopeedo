...
<div id="successModal" class="modal ">
    ...
    <div class="modal-content m-auto" style="max-width:440px; border-radius:16px">
        ...
        <div class="modal-style">
            <a href="{{ route('seller.login') }}" class="modal-button-style btn" id="modal-ok-button">{{  translate('Continue to Login') }}</a>
        </div>
    </div>
  </div>
</div>
                            ...
                            <div class="col-xxl-8 p-4 p-lg-5">
                                ...
                                <div class="pt-2 pt-lg-2 bg-white">
                                        ...
                                        <form class="form-default" id="otp-form" role="form" action="{{ route('password.update') }}" method="POST">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                               <div class="d-flex justify-content-between align-items-center text-black" >
                                                    ...
                                                    <div id="timer" class="fw-600 fs-16 ml-2"> 02:00</div>
                                               </div>
                                    ...
                                    <button class="btn back-btn text-center field-radius" style="border:1px solid #7D9A40; " >
                                        <a href="{{ url('shops/create') }}" class="fs-17 fw-400 d-flex align-items-center justify-content-center " >
                                            {{-- <i class="las la-arrow-left fs-20 mr-1"></i> --}}
                                            {{ translate('Back ')}}
                                        </a>
                                       </button>
