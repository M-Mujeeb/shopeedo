...
<div id="successModal" class="modal ">
    ...
    <div class="modal-content m-auto" style="max-width:440px; border-radius:16px">
        ...
        <div class="modal-style">
            <a href="{{ route('seller.dashboard') }}" class="modal-button-style btn" id="modal-ok-button">{{  translate('Continue to Dashboard') }}</a>
        </div>
    </div>
</div>
</div>
                            ...
                            <div class="col-xxl-8 p-4 p-lg-5">
                                ...
                                <div class=" text-lg-left">
                                    ...
                                    <h5 class="fs-14 fw-400 text-dark">
                                        {{ translate('Enter 4 digit one time password sent to your mobile number') }}
                                    </h5>
                                </div>
