                            ...
                            <div class="col-lg-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        {{-- {{ json_decode($order->shipping_address)->address->city_name }} --}}
                            ...
                            <div class="col-lg-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $platform_fees   ) }}</td> --}}
                    ...
                    <div class="bg-white border rounded-0 mt-4">
                        ...
                        <div class="p-3">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                    <td>{{ $orderDetail->product->getTranslation('name') }} {{ $orderDetail->variation ? '('.$orderDetail->variation. ')' : '' }} </td>
