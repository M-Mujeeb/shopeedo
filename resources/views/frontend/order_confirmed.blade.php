...
@section('content')
    ...
    foreach( $combined_order->orders as $uperkey => $order) {
      foreach ($order->orderDetails as $key => $orderDetail) {
          # code...
          if ($orderDetail->product != null) {
            array_push($products_categories, $orderDetail->product->main_category->is_quick);
            //   echo $orderDetail->product->main_category->is_quick;
          }
      }
    }
                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="card shadow-none border rounded-3 p-4">
                        <div class="d-flex justify-content-between  ">
                            ...
                            <h3 class="fw-400">Delivery Time</h3>
                            @if($quick == 1 )
                            <p class="fs-24" style="">Preparing your order</p>
                            @endif
                        </div>
                        @if($quick == 1)
                            <h2 class="mb-3">45-60 mins</h2>
                            <div class="d-flex justify-content-between" style="width: 60%; gap:10px;">
                                <div class="rounded-4" style="background-color:#7D9A40;  width:152px; height:12px "></div>
                                <div class="rounded-4" style="background-color:#D9D9D9;  width:152px; height:12px "></div>
                                <div class="rounded-4" style="background-color:#D9D9D9;  width:152px; height:12px "></div>
                                <div class="rounded-4" style="background-color:#D9D9D9;  width:152px; height:12px "></div>
                            </div>
                            ...
                            <div class="mt-3">
                               ...
                               <div class="d-flex align-items-center">
                                    <img src="" style="width:100px ; height:100px ; border-radius:100%; border:1px solid #7D9A40">
                                    {{-- <div> --}}
                                        <p class="ml-3"> Delivery Name</p>
                                        {{-- <p>Honda 125</p> --}}
                                    {{-- </div> --}}
                                </div> 
                            </div>
                        ...
                        @endif
                        <div class="mt-3" style="color:#000000B0">
                            When it’s ready, the delivery will be on its way to you.
                        </div>
                    </div>

                     <!-- Order Summary -->
                     <div class="mb-4 bg-white  border rounded-3">
                        <h5 class="fw-600 mb-3 fs-35 text-soft-dark p-4 border-bottom">{{ translate('Order Details')}}</h5>
                        <div class="row p-4">
                            <div class="col-md-6">
                                <table class="table fs-15 text-soft-dark">
                                    <tr>
                                        <td class="w-50 fw-600 border-top-0 pl-0 py-2">{{ translate('Order Code')}}</td>
                                        <td class="border-top-0 py-2">{{    $first_order->code }}</td>
                                    </tr>
                                    <tr>
                                        <td class="w-50 fw-600 border-top-0 pl-0 py-2">{{ translate('Order date  & time')}}:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 py-2">{{ json_decode($first_order->shipping_address)->address }}, {{ json_decode($first_order->shipping_address)->city }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <table class="table fs-15">
                                    ...
                                    <tr>
                                        <td class="w-50 fw-600 border-top-0 py-2">{{ translate('Total amount')}}:</td>
                     ...
                     <div class="card shadow-none border rounded-3">
                        <h5 class="fw-600 text-soft-dark mb-3 fs-16 pb-2 border-bottom p-4">{{ translate('Order Summary')}}</h5>
                         ...
                         <div class="card-body">
                             ...
                             <div>
                                         ...
                                         <thead>
                                             <tr>
                                                {{-- opacity-60 --}}
                                                 ...
                                                 <th class=" border-top-0" width="30%">{{ translate('Product')}}</th>
                                                 <th class=" border-top-0">{{ translate('Variation')}}</th>
                                                 <th class=" border-top-0">{{ translate('Quantity')}}</th>
                                                 {{-- <th class=" border-top-0">{{ translate('Delivery Type')}}</th>
                                                 <th class=" border-top-0 pr-0">{{ translate('Order')}}</th> --}}

                                                 <th class=" border-top-0 pr-0">{{ translate('Price')}}</th>
                                         ...
                                         <tbody>
                                          ...
                                          @endphp
                                            ...
                                            @foreach ($combined_order->orders as $uperkey => $order)
                                             @foreach ($order->orderDetails as $key => $orderDetail)
                                                 <tr>
                                                     <td class="border-top-0 border-bottom ">{{ $uperkey+1 }}</td>
                                                     ...
                                                     <td class="border-top-0 border-bottom">
                                                        ...
                                                        <td class="border-top-0 border-bottom pr-0">{{$order->code }}</td> --}}
                                 ...
                                 <!-- Order Amounts -->
                                 <div class="row">
                                     <div class="col-xl-4 col-md-6 ml-auto " style="margin-right: 5rem">
                                         <table class="table ">
                                             <tbody>
                                                 <!-- Subtotal -->
                                                 <tr>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="border-top-0 pr-0 py-2">
                                                         ...
                                                         <span >{{ single_price($combined_order->shipping_cost) }}</span>
                                                     </td>
                                                 </tr>
                                                 <!-- Tax -->
                                                 <tr>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <!-- platform-fees -->
                                                  <tr>
                                                    <th class="border-top-0 py-2">{{ translate('Platform Fees')}}</th>
                                                    <td class="border-top-0 pr-0 py-2">
                                                        {{-- <span>{{ single_price($order->coupon_discount) }}</span> --}}
                                                        <span>{{ single_price($platform_fees) }}</span>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="pr-0">
                                                         ...
                                                         <strong><span>{{ single_price($combined_order->grand_total) }}</span></strong>
