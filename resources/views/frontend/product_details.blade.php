...
@section('style')
    ...
    .btn-slide-secondary-base:hover, .btn-slide-secondary-base:focus {
    box-shadow: inset 25em 0 0 0 #7d9a40 !important;
...
@section('modal')
    ...
    <!-- sharing Modal -->
    <div class="modal fade sharing_Modal1"  id="sharing_Modal1" tabindex="-1" role="dialog" aria-labelledby="sharingModalLabel" aria-hidden="true">
        <div class="modal-dialog sharing-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="sharingModalLabel">{{ translate('Share Product') }}</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
