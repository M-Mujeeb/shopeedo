...
@section('panel_content')
    <div class="card shadow-none rounded-0 border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-20 fw-700 p-2 text-dark">{{ translate('Download Your Products') }}</h5>
        </div>
        <div class="card-body">
            <table class="table aiz-table mb-0">
                <thead class="text-gray fs-12">
                    <tr>
                        <th class="pl-2">{{ translate('Product')}}</th>
                        <th class="pr-2 text-right" width="20%">{{ translate('Option')}}</th>
                    </tr>
                </thead>
                <tbody class="fs-14">
                        @foreach ($orders as $key => $order_id)
                            ...
                            <tr>
                                ...
                                <td class="pr-2 text-right" style="vertical-align: middle;">
