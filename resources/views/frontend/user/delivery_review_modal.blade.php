<div class="modal-header">
    <h5 class="modal-title h6">{{translate(' Delivery Review')}}</h5>
...
$delivery_avatar = "";
// $carts = [];
if ( $delivery_boy && $delivery_boy->avatar_original != null) {
    $delivery_avatar = uploaded_asset($delivery_boy->avatar_original);
}
@endphp

@if($review == null)
    <!-- Add new review -->
    <form action="{{ route('ratings.rateDeliveryBoyStore') }}" method="POST" >
        @csrf
        <input type="hidden" name="delivery_id" value="{{ $delivery_boy->id }}">
        <input type="hidden" name="order_id" value="{{ $order_id }}">

        <div class="modal-body">
            <div class="form-group">
                <div style="margin: auto; width:100px">
                <img src="{{ $delivery_avatar }}" width="100px" alt="">
