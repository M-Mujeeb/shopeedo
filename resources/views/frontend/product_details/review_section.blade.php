<div class="bg-white border mb-4">
    ...
    <div class="px-3 px-sm-4 mb-4">
        ...
        <div class="border border-secondary-base  p-3 p-sm-4" style="background-color: #7D9A4047 !important; border-color:#7D9A40 !important; border-radius:8px !important;">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-right">
                    ...
                    <a  href="javascript:void(0);" onclick="product_review('{{ $detailedProduct->id }}')"
                        class="btn btn-primary fw-400 rounded-2 text-white" style="backgroun">
