...
<div class="text-left">
    ...
    <div class="d-flex justify-content-between">
        <h2 class="mb-2 fs-30 fw-700 text-dark">
        ...
        <div class="">
            @if ($detailedProduct->auction_product != 1)
                <div class="d-flex justify-content-between align-items-center" style="gap:30px">
                    {{-- onclick="shareBtn()" --}}
                    {{-- <button id="share_btn" onclick="shareList({{ $detailedProduct->id }})" >hi</button> --}}
                    <a href="javascript:void(0)" onclick="shareList({{ $detailedProduct->id }})" >
                        <svg width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.864 1.0614C15.142 1.19461 14.5404 1.5212 13.9904 2.06694C13.565 2.49236 13.2728 2.95216 13.1138 3.45493C12.8602 4.2585 12.8602 4.76127 13.1224 5.83557C13.1395 5.90862 12.7614 6.15786 10.2304 7.72633C8.6318 8.71468 7.30397 9.53115 7.28678 9.53974C7.26959 9.54834 7.102 9.42802 6.91722 9.27332C6.52188 8.93814 5.94606 8.63734 5.46478 8.50842C5.00498 8.3881 4.18421 8.3795 3.7459 8.49123C2.65871 8.77485 1.72193 9.54404 1.29221 10.5195C1.06875 11.0309 1 11.3746 1 11.9977C1 12.6208 1.06875 12.9646 1.29221 13.476C1.71763 14.4299 2.63723 15.2034 3.68574 15.4828C4.17992 15.616 4.9663 15.616 5.46478 15.487C5.94606 15.3581 6.52188 15.0573 6.91722 14.7221C7.102 14.5675 7.26959 14.4471 7.28678 14.4557C7.30397 14.4643 8.6318 15.2808 10.2304 16.2691C12.7614 17.8376 13.1395 18.0868 13.1224 18.1599C12.8602 19.2385 12.8602 19.767 13.1181 20.5491C13.2942 21.0734 13.5435 21.473 13.9732 21.907C14.5533 22.4958 15.185 22.8266 15.98 22.9556C17.7805 23.2478 19.5466 22.0703 20.015 20.2698C20.2127 19.5135 20.1096 18.5423 19.7529 17.8204C19.1341 16.5656 17.8922 15.805 16.4871 15.8136C15.5589 15.8179 14.7725 16.1273 14.0763 16.759L13.8443 16.9696L12.2543 15.9812C11.382 15.4398 10.0542 14.619 9.31076 14.1592C8.56734 13.6951 7.95285 13.317 7.94855 13.3127C7.94425 13.3084 7.97433 13.1838 8.0216 13.0334C8.21497 12.3845 8.21497 11.611 8.0216 10.9621C7.97433 10.8117 7.94425 10.6871 7.94855 10.6828C7.95285 10.6785 8.56734 10.3003 9.31076 9.83625C10.0542 9.37645 11.382 8.55569 12.2543 8.01424L13.8443 7.02589L14.1107 7.26653C15.2065 8.24629 16.7879 8.46975 18.0985 7.82946C19.0439 7.36537 19.7701 6.46296 20.015 5.44453C20.144 4.92457 20.144 4.21124 20.015 3.72565C19.5338 1.87786 17.7203 0.713327 15.864 1.0614ZM17.1359 2.39782C18.3134 2.7459 19.0224 3.93622 18.7431 5.11364C18.6442 5.52617 18.4423 5.88284 18.1243 6.20083C17.6387 6.68641 17.0414 6.91416 16.3796 6.87119C15.7823 6.82822 15.3096 6.61336 14.8971 6.19224C13.9947 5.27694 14.042 3.76433 14.9959 2.90489C15.2409 2.68573 15.5288 2.52674 15.8854 2.41072C16.1948 2.31188 16.8179 2.30329 17.1359 2.39782ZM5.32727 9.84055C5.98473 10.0769 6.50899 10.6054 6.73674 11.2672C6.87855 11.6626 6.87855 12.3329 6.73674 12.7283C6.50469 13.3857 5.98044 13.9229 5.33586 14.1506C4.9749 14.2795 4.39048 14.3053 4.02522 14.2108C2.99819 13.9444 2.30634 13.0548 2.30634 12.002C2.30634 10.9621 2.95522 10.0984 3.96076 9.79757C4.31313 9.69444 4.9749 9.71593 5.32727 9.84055ZM17.0371 17.1758C17.8664 17.3735 18.5454 18.0482 18.7431 18.8775C19.0224 20.0593 18.3177 21.2496 17.1359 21.5976C16.8308 21.6879 16.2292 21.6879 15.9241 21.5976C15.1291 21.3613 14.5576 20.7898 14.3213 19.9948C14.2353 19.6983 14.231 19.1397 14.317 18.8088C14.5361 17.9708 15.2881 17.2833 16.1433 17.1415C16.3839 17.1028 16.7836 17.1157 17.0371 17.1758Z" fill="black" stroke="black" stroke-width="0.45"/>
                            </svg>
                    ...
                    <a href="javascript:void(0)" onclick="addToWishList({{ $detailedProduct->id }})"
                        ...
                        <svg width="26" height="22" viewBox="0 0 26 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.34215 1C4.09185 1 1.45605 3.48521 1.45605 6.55134C1.45605 9.02646 2.48612 14.9008 12.6255 20.839C12.8071 20.9443 13.0156 21 13.2282 21C13.4408 21 13.6494 20.9443 13.831 20.839C23.9704 14.9008 25.0004 9.02646 25.0004 6.55134C25.0004 3.48521 22.3646 1 19.1143 1C15.864 1 13.2282 4.36445 13.2282 4.36445C13.2282 4.36445 10.5925 1 7.34215 1Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-12">
            ...
            {{-- <h1>hi</h1> --}}
            {{-- $detailedProduct->main_category->parent_id == 0   &&   --}}
            @if($detailedProduct->main_category->is_quick !=0  )
            <div class="my-2">
                <span class="fw-500 fs-15 p-2 " style="color:#F49E00; background-color:#F7E5C4; border-radius:8px; ">Quick Commerce</span>
            </div>
            @else
            <div class="my-2">
                <span class="fw-500 fs-15 p-2 " style="color:#F49E00; background-color:#F7E5C4; border-radius:8px; ">Ecommerce</span>
            </div>
            @endif
        </div>
            ...
            @else
                <div class="row no-gutters mt-2 mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="d-flex align-items-center">
                            <!-- Discount Price -->
                            <strong class="fs-30 fw-500 text-primary">
                                {{-- {{ home_discounted_price($detailedProduct) }} --}}
                            </strong>
                            <!-- Unit -->
                            {{-- @if ($detailedProduct->unit != null)
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            @if ($detailedProduct->digital == 0)
                ...
                <!-- Total Price pb-3 -->
            <div class="row no-gutters mb-2" id="chosen_price_div">
                {{-- <div class="col-sm-2">
                    <div class="text-secondary fs-14 fw-400 mt-1">{{ translate('Total Price') }}</div>
                </div> --}}
                <div class="col-sm-10">
                    <div class="product-price">
                        <strong id="chosen_price" class="fs-30 fw-500 text-primary">
        ...
        <div class="mt-3">
            @if ($detailedProduct->digital == 0)
                ...
                @else --}}
                    ...
                    {{-- btn-primary --}}
                     @if($detailedProduct->user->shop->shop_status == 1)
                    <button type="button" class="btn  buy-now fw-600 add-to-cart min-w-150px rounded-8" style=" border:1px solid #7D9A40; color:#7D9A40; margin-right: 19px"
                        @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="addToCart()" @else onclick="showLoginModal()" @endif>
                        <i class="la la-shopping-cart"></i> {{ translate('Buy Now') }}
                    </button>
                    <button type="button"
                    {{-- btn-secondary-base --}}
                        class="btn  mr-2 add-to-cart fw-600 min-w-150px rounded-8 text-white" style=" background-color:#7D9A40; color:white;"
                        @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="addToCart()" @else onclick="showLoginModal()" @endif>
                ...
                @else
                <span class="rounded-0 buy-now fw-600 add-to-cart p-2" style="background-color:#7d9a40; color:white">Currently Offline</span>
            @endif   
