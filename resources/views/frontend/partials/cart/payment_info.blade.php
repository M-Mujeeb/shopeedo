...
<div>
    ...
    <div class="row gutters-10">
                ...
                <label class="aiz-megabox d-block mb-3">
                    ...
                    <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                        ...
                        <span class="rounded-1 h-40px overflow-hidden">
                            <img src="{{ static_asset('assets/img/cards/'.$payment_method->name.'.svg') }}"
                            class="img-fit h-100">
                        </span>
                    </span>
                </label>
        ...
        @php
            ...
            // Check if total exceeds maximum COD amount
            if ($max_cod_amount && $total > $max_cod_amount) {
                $show_cod = false;
            }

            // Check for excessive cancel orders
            if ($cancel_orders >= 3) {
                $show_cod = false;
            }
                ...
                <label class="aiz-megabox d-block mb-3">
                    ...
                    <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                        ...
                        <span class="rounded-1 h-40px w-70px overflow-hidden">
                            <img src="{{ static_asset('assets/img/cards/cod.svg') }}"
                            class="img-fit h-100">
                        </span>
                    </span>
                </label>
