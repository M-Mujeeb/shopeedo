<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="" value="{{ $address_data->name }}" name="name" value="" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <input type="text" class="form-control mb-3 rounded-0" id="edit_city" name="city_name" value="{{ $address_data->city_name }}" readonly="">
        ...
        @if (get_setting('google_map') == 1)
            ...
            <div class="row mt-3 mb-3">
                <input id="edit_searchInput" class="controls" type="text" placeholder="Enter a location" style="padding: 12px !important">
                <div id="edit_map"></div>
                <ul id="geoData">
