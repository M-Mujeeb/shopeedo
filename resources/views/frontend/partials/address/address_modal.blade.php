                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="tel" id="phone-code" class="form-control rounded-0" placeholder="Add a name for address" name="name" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {{-- <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="city_name" required>

                                </select> --}}
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Your City')}}" name="city_name" required="">
                            </div>
                        </div>
                         <!-- Address -->
                         <div class="row">
