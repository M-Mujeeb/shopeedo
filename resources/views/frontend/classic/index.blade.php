...
/*
    ...
    .category-item:hover {
    transform: translateY(-3px); /* Move the container 10px upwards */
    box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2);
}
    .category-item:not(:nth-child(-n+1))::before {
        content: '';
        position: absolute;
        left: -10px; /* Half of the gap */
        top: 0;
        bottom: 0;
        width: 1px;
    ...
    .category-item img {
        ...
        height: auto;
        max-width: 150px;
        max-height: 150px; /* Set the same max height for all images */
        object-fit: cover;
        border-radius: 10px;
        margin-bottom: 10px;
    }
    ...
    {{-- <button onclick="getCurrentLocation()">Detect My Location</button> --}}
        ...
        <div class="row  py-4 m-auto" style="background-color: #F8F8F8">
             <!-- Divider -->
          <div class="d-none d-md-block col-md-1">
            <div class="vertical-divider" style="background-color: transparent;"></div>
          </div>
          <!-- 1st Icon and Text -->
          <div class="col-12 col-md-3 d-flex flex-column icon-text">
            {{-- <img src="icon1.png" alt="7 Days Easy Return" class="mb-2" style="width: 50px;"> --}}
            <div class="w-md-50 ml-md-4 ">
               
                <img src="{{ static_asset('svg/easy-return.svg') }}" alt="Example SVG">
                <p class="mt-2 fw-600 fs-14">7 Days Easy Return</p>
            </div>
          ...
          <!-- 2nd Icon and Text -->
          <div class="col-12 col-md-3 d-flex flex-column icon-text">
            {{-- <img src="icon2.png" alt="Cash on Delivery" class="mb-2" style="width: 50px;"> --}}
            <div class="w-md-50 ml-md-4">
                <img src="{{ static_asset('svg/cash-on-delivery.svg') }}" alt="Example SVG">
                <p class="mt-2 fw-600 fs-14">Cash on Delivery</p>
          ...
          <div class="col-12 col-md-3 d-flex flex-column icon-text">
            {{-- <img src="icon2.png" alt="Cash on Delivery" class="mb-2" style="width: 50px;"> --}}
            <div class="w-md-50 ml-md-4">
                <img src="{{ static_asset('svg/lowest.svg') }}" alt="Example SVG">
                <p class="mt-2 fw-600 fs-14">Lowest Price</p>
    ...
    <!-- Categories -->
    <div class="container ">
        {{-- <h4 class="py-4 fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">Categories</h4> --}}
...
{{--
          ...
          <div class="category-grid mt-3">
            ...
            <div class="category-item">
                ...
                @php
                    ...
                    // echo $fileName;
                @endphp
                <img src="{{ static_asset($fileName) }}" alt="{{ $category->name }}">
                <span>   <a href="{{ route('products.category', $category->slug) }}" class="fs-15 fw-500" style="color:black">
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="flash_deal">
            <div class="container">
                ...
                <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
                    {{-- fs-22 fs-md-20 fw-700 --}}
                    <h4 class=" mb-2 mb-sm-0 py-4 fs-16 fs-md-20 fw-700 ">
                    ...
                    <div>
                        <div class="text-dark d-flex align-items-center mb-0">
                            <span class="  border-soft-light border-width-2 pl-3">
                                <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                                    class="fs-18 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary" style="color:#7D9A40 !important">{{ translate('View All') }}
                                    <svg width="7" height="10" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 11L6 6L1 1" stroke="#7D9A40" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </a>
                            </span>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="5" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                            @foreach ($flash_deal_products as $key => $flash_deal_product)
                                <div class="carousel-box px-3 position-relative has-transition hov-animate-outline  " style="border:2px solid #EDEDED">
                                    @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                        ...
                                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
                                            <a href="{{ $product_url }}"
                                                ...
                                                <a href="javascript:void(0)" class="hov-svg-white" onclick="addToWishList({{ $flash_deal_product->product->id }})"
                                        ...
                                        <div
                                        class="fs-10 fs-md-14 mt-md-3  h-md-80px   lh-1-5">
    ...
    @if (get_setting('coupon_system') == 1)
        <div class="mb-2 mb-md-3 mt-2 mt-md-3"
        {{--  {{ get_setting('cupon_background_color', '#292933') }} --}}
            style="background-color: transparent; color:black">
            <div class="container"  style="border: 2px solid #7D9A40; border-radius:10px; background-color:#7D9A40; color:white;  box-shadow: inset 4px 4px 4px rgba(0, 0, 0, 0.25);">
                <div class="row py-5">
                    <div class="col-xl-8 text-center text-xl-left pl-2">
                        <div class="d-lg-flex align-items-center">
                            <div class="mb-3 mb-lg-0">
                             ...
                             <img src="{{static_asset('svg/coupon.svg')}}" alt="">

                            </div>
                            <div class="ml-lg-3">
                                {{-- text-white --}}
                                <h5 class="fs-26 fw-600">{{ translate(get_setting('cupon_title')) }}</h5>
                    ...
                    {{-- mt-4 --}}
                    {{-- text-xl-right --}}
                    <div class="col-xl-4 text-center  d-flex align-items-center  justify-content-center justify-content-md-end  ">
                        <a href="{{ route('coupons.all') }}"
                        {{-- text-white hov-bg-white hov-text-dark--}}
                            class="btn fw-600   border border-width-2 fs-18 px-4 mr-2"
                            {{-- box-shadow: 0px 20px 30px rgba(0, 0, 0, 0.16); --}}
                            style="border-radius: 10px;background: white; color:#7D9A40; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">{{ translate('View All Coupons') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    ...
                    <!-- Links -->
                    <div class="d-flex">
                        <a class="text-blue fs-10 fs-md-12 fw-700  animate-underline-primary" style="color:#7D9A40 !important; margin-right:14px"
                ...
                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                    ...
                    @foreach ($best_selers as $key => $seller)
                        @if ($seller->user != null)
                            <div
                                class="carousel-box h-100 position-relative text-center border has-transition hov-animate-outline">
                                <div class="position-relative px-3" style="padding-top: 2rem; padding-bottom:2rem;">
                                    ...
                                    <!-- Shop name -->
                                    <h2 class="fs-14 fw-700 text-dark text-truncate-2 h-40px mt-3 mt-md-4 mb-0 ">
                                        <a href="{{ route('shop.visit', $seller->slug) }}"
                                    ...
                                    <div class="rating rating-mr-2 text-dark mb-3">
                                        ...
                                        <div class="opacity-60 fs-14">({{ $seller->num_of_reviews }}
                                            {{ translate('Reviews') }})</div>
                                    </div>
                                    <!-- Visit Button -->
                                    <a href="{{ route('shop.visit', $seller->slug) }}" style="background-color:#7D9A40;color:white;padding: 8px 35px;border-radius: 8px">
                                        {{-- class="btn-visit" --}}
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                        <span class="">{{ translate('Popular Products') }}</span>
                    </h3>
                </div>
                <!-- Product Section -->
                {{-- px-sm-3  --}}
                <div class="">
                    ...
                    {{-- <div class="aiz-carousel sm-gutters-16 " data-items="5" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'> --}}

                    <div id="product-list" class="d-flex flex-wrap "  style="gap:10px">
                ...
                <div class="text-center mt-4">
                    <button id="load-more" class="btn fs-17 fw-500 " style="background-color:white; color:#7D9A40; border:1px solid#7D9A40; padding:12px 44px; border-radius:8px">Load More</button>
                </div>
            </div>
        </section>
