...
<div class="card">
    <form class="" id="sort_sellers" action="" method="GET">
        ...
        <a href="{{ route('sellers.export-sellers') }}"  class="text-align:end btn btn-primary" style="float: right; margin-top:5px; margin-right:5px">Export</a>
                ...
                @foreach($shops as $key => $shop)
                    <tr>
                        ...
                        <td>
                         ...
                         <td>{{date('d-m-Y', strtotime($shop->user->created_at))}}</td>
