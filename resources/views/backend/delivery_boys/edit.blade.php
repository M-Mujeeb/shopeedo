    ...
    <div class="card">
        ...
        <form action="{{ route('delivery-boys.update', $delivery_boy->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{translate('Bank Name')}}</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="bank_name" value="{{$delivery_boy_details->bank_name}}" placeholder="Bank Name" required>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{translate('Account Name')}}</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="bank_acc_name" value="{{$delivery_boy_details->bank_acc_name}}" placeholder="Account Name" required>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{translate('Account Number')}}</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="bank_acc_no" value="{{$delivery_boy_details->bank_acc_no}}" placeholder="Account Number" required>
                    </div>
                </div>
