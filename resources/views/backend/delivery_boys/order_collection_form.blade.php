    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                ...
                <input type="number" class="form-control" id="payout_amount" name="payout_amount" required min="1">
...
<script type="text/javascript">
    (function($) {
        ...
        $('#payout_btn').on('click', function(event) {
            var payoutAmount = $('#payout_amount').val().trim();
