...
<div class="modal-header">
    <h5 class="mb-0 h6">{{translate('Bonus Payment to Delivery Boy')}}</h5>
    <button type="button" class="close" data-dismiss="modal">
    </button>
</div>

<form class="form-horizontal" action="{{ route('bonus-to-delivery-boy') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" value="{{ $total_payable }}" readonly="">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-4 col-from-label">
