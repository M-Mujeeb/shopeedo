                ...
                @foreach (json_decode($verification_form) as $key => $element)
                    @if ($element->type == 'text')
                        <div class="row">
                            ...
                            @if($element->label === "National ID")
                            <div class="col-md-10">
                                <input type="{{ $element->type }}" class="form-control mb-3" id="cnic" placeholder="{{ $element->label }}" name="element_{{ $key }}" required>
                            </div>
                            @elseif($element->label === "Phone Number")
                            <div class="col-md-10">
                                <input type="{{ $element->type }}" class="form-control mb-3" id="phone" placeholder="{{ $element->label }}" name="element_{{ $key }}" required>
                            </div>
                            @else
                            <div class="col-md-10">
                    ...
                    @elseif($element->type == 'file')
                        <div class="row">
                            <div class="col-md-2">
                                @if($element->label === "Front Side Picture" || $element->label === "Back Side Picture" )
                                <label>{{ $element->label }} <span class="text-danger">*</span> </label>
                                @else
