    ...
    <div class="row">
        <div class="col-md-4 mx-auto mb-3" >
            <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" data-toggle="modal" data-target="#ticket_modal">
                <span class="size-70px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3" style="background-color:#7D9A40 !important">
              ...
              <table class="table aiz-table mb-0">
                  ...
                  <tbody>
                      @foreach ($tickets as $key => $ticket)
                          <tr class="{{ $ticket->client_viewed == 0 ? 'status_style' : ''  }}">
                              <td>#{{ $ticket->code }}</td>
