        ...
        <div class="card-header row gutters-5">
            <div class="text-center text-md-left">
               ...
               <div class="mt-2">
                   ...
                   <span class="badge badge-inline badge-secondary ml-2" style="background-color:orange !important"> {{ translate(ucfirst($ticket->status)) }} </span>
               </div>
            </div>
        </div>
        <div class="card-body">
            <div class="pad-top">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-0 " style="display: flex; flex-direction: column; align-items: end;">
                        <div class="media">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            @foreach ((explode(",",$ticket->files)) as $key => $file)
                                ...
                                @if($file_detail != null)
                                {{-- max-width:100px --}}
                                <div class="d-flex flex-column p-2" style=" border:1px solid rgba(0, 0, 0, 0.079)">
                                <img src="{{ uploaded_asset($file) }}" alt="{{ $file_detail->file_original_name }}" class="img-fluid mb-2" style="max-width: 100px; max-height: 100px;">
                    ...
                    @foreach($all_tickets_users as $ticketreply)

                        <li class="list-group-item px-0 {{ $ticketreply['user_type'] != 'admin' ? 'd-flex flex-column align-items-end' : '' }}">
                            <div class="media">
                                <a class="media-left" href="#">
                                    @if($ticketreply['avatar'] != null)
                                        <span class="avatar avatar-sm mr-3">
                                            <img src="{{ uploaded_asset($ticketreply['avatar']) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';">
                                        </span>
                                    @else
                                        <span class="avatar avatar-sm mr-3">
                                            <img src="{{ static_asset('assets/img/avatar-place.png') }}">
                                ...
                                <div class="media-body">
                                    <div class="comment-header">
                                        <span class="text-bold h6 text-muted">{{ $ticketreply['user_name'] }}</span>
                    ...
                    <div class="col-md-12">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            <div class="input-group-prepend">
                                <div class="input-group-text bg-soft-secondary font-weight-medium" style="background-color: #7D9A40 !important; color:white">{{ translate('Browse')}}</div>
                            </div>
