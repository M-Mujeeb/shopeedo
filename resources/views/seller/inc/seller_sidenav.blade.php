            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.digitalproducts') }}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Add Digital Products') }}</span>
                            </a>
                        </li> --}}
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Manage Discount') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                @if (get_setting('coupon_system') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('seller.coupon.index') }}"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Discount Vouchers & Coupons') }}</span>
                        </a>
                    </li>
                @endif
                </ul>
                    ...
                    {{-- <ul class="aiz-side-nav-list level-2"> --}}
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.vendor_refund_request') }}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Manage Refunds') }}</span>
                            </a>
                        </li>
                    @endif
                    {{-- </ul> --}}
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Manage Payments') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
              ...
              <ul class="aiz-side-nav-list level-2">
                ...
                @if (get_setting('conversation_system') == 1)
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('seller.conversations.index') }}"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Customer Chat') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.support_ticket.index') }}"
                        ...
                        @if ($support_ticket > 0)
                            <span class="badge badge-inline badge-success" style="background-color: #7D9A40 !important">{{ $support_ticket }}</span>
                        @endif
                    </a>
                </li>
