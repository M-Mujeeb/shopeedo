...
@section('css')
    <style>
        .clear-btn {
            background-color: #D9D9D9; padding:10px 43px; border-radius:5px;
            color: black;
        }
        .clear-btn:hover {
            color: black;
...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row ">
            ...
            <a href="javascript:void(0);" onclick="clearTempdata()" class="clear-btn">Clear All</a>
            </div>
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg" class="text-center" style="padding-left: 8%;">{{ translate('Action') }}</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" style="max-width: 400px;" >
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title h6">{{translate('Discount Confirmation')}}</h4>
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mt-1 fs-14">{{translate('Are you sure you want to set this discount?')}}</p>
                    <div>
                        <button type="button" class="btn btn-secondary rounded-0 mt-2" data-dismiss="modal">{{ translate('Cancel') }}</button>
                        <a href="javascript:void(0)" id="trigger_btn" data-value="" class="btn btn-danger rounded-0 mt-2" onclick="setDiscount()">{{translate('Confirm')}}</a>
                    </div>
                </div>
            </div>
        </div>
