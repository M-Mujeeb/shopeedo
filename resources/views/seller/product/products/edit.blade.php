    ...
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <option value="" disabled>{{ translate('Select Unit') }}</option>
                        <option value="kg" {{ $product->unit == 'kg' ? 'selected' : '' }}>{{ translate('kg') }}</option>
                        <option value="pc" {{ $product->unit == 'pc' ? 'selected' : '' }}>{{ translate('pc') }}</option>
                        <option value="lbs" {{ $product->unit == 'lbs' ? 'selected' : '' }}>{{ translate('lbs') }}</option>
                        <option value="g" {{ $product->unit == 'g' ? 'selected' : '' }}>{{ translate('g') }}</option>
                        <option value="oz" {{ $product->unit == 'oz' ? 'selected' : '' }}>{{ translate('oz') }}</option>
                        </select>
            ...
            <div class="card">
                ...
                {{-- Product video comment for babar  --}}
                {{-- <div class="card">
                    <div class="card-header">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="aizuploader">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary-new font-weight-medium">{{ translate('Browse')}}
                                    </div>
                                </div>
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
