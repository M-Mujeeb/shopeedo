...
@section('panel_content')
    ...
    <div class="aiz-titlebar mt-2 mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Money Withdrawal') }}</h1>
        </div>
      </div>
    </div>
    ...
    <div class="row gutters-10">
        <div class="col-md-4 mb-3 ml-auto" >
            {{-- bg-grad-1 --}}
            <div class=" text-white bg-primary  rounded-lg overflow-hidden">
              <span class="size-30px rounded-circle mx-auto bg-soft-primary d-flex align-items-center justify-content-center mt-3">
                  {{-- <i class="las la-dollar-sign la-2x text-white"></i> --}}
                  <span class="text-white font-weight-bold">PKR</span>
        ...
        <div class="col-md-4 mb-3 mr-auto" >
          <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" onclick="show_request_modal()">
              ...
              <div class="fs-18 text-primary">{{ translate('Send Withdrawal Request') }}</div>
          </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Withdrawal Request history')}}</h5>
        </div>
          <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ translate('Send A Withdrawal Request') }}</h5>
                ...
                @else
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="p-5 heading-3">
                            {{ translate('You do not have enough balance to send withdrawal request') }}
                        </div>
                    </div>
                @endif
            </div>
