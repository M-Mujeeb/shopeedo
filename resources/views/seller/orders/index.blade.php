    ...
    <div class="card">
        <form class="" action="" id="sort_orders" method="GET">
            <div class="card-header row gutters-5">
                ...
                <div id="export-action" class="dropdown mb-2 mb-md-0" style="display:none" >
                                ...
                                @if ($order != null)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('seller.invoice.download.mini', $order->id) }}"
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).on('change', '.check-one', function() {
             // Check if any .check-one checkbox is checked
