            ...
            <div class="aiz-user-panel">
                <div class="card rounded-0 shadow-none border">
                    <div class="card-header border-bottom-0">
                        <h5 class="mb-0 fs-20 fw-700 p-2 text-dark">{{ translate('Applied Refund Requests') }}</h5>
                    </div>
                        ...
                        <table class="table aiz-table mb-0">
                            <thead class="text-gray fs-12">
                                <tr>
                                  ...
                                  <th class="text-right pr-2 w-140px">{{translate('Status')}}</th>
                                </tr>
                            </thead>
                            <tbody class="fs-14">
                                  @foreach ($refunds as $key => $refund)
                                      <tr>
                                          <td class="pl-2 text-dark" style="vertical-align: middle;">{{ sprintf('%02d', $key+1)  }}</td>
