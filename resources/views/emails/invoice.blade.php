	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->city }}, </td></tr>
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price($order->combinedOrder->shipping_cost) }}</td>
			        </tr>
                    ...
                    <tr class="border-bottom">
			            ...
			            <td class="currency">{{ single_price($order->coupon_discount) }}</td>
							...
							<tr class="border-bottom">
								...
								<td class="currency">{{ single_price($setting)  }}</td> 
						</tr>
						<tr>
								<th class="text-left strong">{{ translate('Grand Total') }}</th>
								<td class="currency">{{ single_price($combinedOrder)   }}</td>
						</tr>
		        </tbody>
		    </table>
	    </div>
