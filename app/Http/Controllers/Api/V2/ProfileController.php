    ...
    public function updateEmail(Request $request)
    {
        ...
        if (isset($request->email)) {
            ...
            if (isUnique($request->email)) {
                ...
                $array['link'] = route('profile//email-change/callback') . '?new_email_verificiation_code=' . $verification_code . '&email=' . $request->email;
                $array['sender'] = $user->name;
                $array['details'] = translate("Email Second");
                $user->new_email_verificiation_code = $verification_code;
                $user->save();
                Mail::to($request->email)->queue(new SecondEmailVerifyMailManager($array));

                return response()->json([
                    'result' => true,
                    'message' => translate("Your verification mail has been Sent to your email.")
                ]);
                ...
                return response()->json([
                    'result' => false,
                    'message' => translate("Email already exist!")
                ]);
            }
        }
        ...
        return response()->json([
            'result' => true,
            'message' => translate("Profile Email updated")
        ]);
    }
