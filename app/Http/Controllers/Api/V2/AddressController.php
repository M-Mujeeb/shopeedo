...
class AddressController extends Controller
{
    ...
    {
        return new AddressCollection(Address::where('id', $id)->get());
    }
    ...
    public function createShippingAddress(Request $request)
    {
        ...
        $address->longitude = $request->lang;
    ...
    public function getShippingAddressDefault()
    {
        $address =Address::where('user_id', auth()->user()->id)->where('set_default', 1)->first(); //make all user addressed non default first
        // dd($address);
        // $address = Address::find($request->id);
        // $address->set_default = 1;
        // $address->save();
        return response()->json([
            ...
            // 'result' => true,
            'message' => translate('Default shipping address')
        ]);
    }
