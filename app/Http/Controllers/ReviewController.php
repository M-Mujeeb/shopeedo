...
class ReviewController extends Controller
{
    ...
    public function delivery_review_modal(Request $request)
    {

        // dd($request->all());
        $delivery_boy = User::where('id', $request->delivery_id)->first();
        $order_id = $request->order_id;
        $review = Rating::where('user_id', Auth::user()->id)->where('order_id', $request->order_id)->first();
        return view('frontend.user.delivery_review_modal', compact('delivery_boy', 'review', 'order_id'));
    }
}
