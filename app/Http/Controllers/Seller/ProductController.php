...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = Product::where('user_id', Auth::user()->id)->where('digital', 0)->where('auction_product', 0)->where('wholesale_product', 0)->orderBy('created_at', 'desc')->with('photo')->with('main_category');
        ...
        if ($request->has('search') || $request->has('category')) {
            ...
            if ($request->has('category') && $request->category != null) {
                ...
                $products->whereHas('main_category', function ($query) use ($selectedCategory) {
        ...
        $latestProduct = Product::where('user_id', Auth::user()->id)
            ->where('digital', 0)
        ...
        if ($latestProduct) {
            ...
            $isDuplicate = Product::where('name', $latestProduct->name)
        ...
        // return view('seller.product.products.index', compact('products', 'search', 'categories', 'selectedCategory', 'duplicateNames'));


        return view('seller.product.products.index', compact('products', 'search', 'categories', 'selectedCategory', 'isDuplicate', 'latestProduct'));
    }
