...
class VerificationController extends Controller
{
    ...
    */
    ...
    public function resend(Request $request)
    {
        ...
        //     $request->user()->verification_code = rand(1000, 9999);
        //     $request->user()->forget_password_time = now();

        //     $array['view'] = 'emails.verification';
        //     $array['from'] = env('MAIL_FROM_ADDRESS');
        //     $array['subject'] = translate('Seller Account Verification');
        //     $array['content'] = translate('Verification Code is') . ': ' . $request->user()->verification_code;

        //     Mail::to(auth()->user()->email)->queue(new SecondEmailVerifyMailManager($array));
        //     flash(translate('Your OTP has been sent!'))->success();
        //     return view('auth.free.verify_login_unverified_email', ['userId' => $request->user()->id]);
        // }
