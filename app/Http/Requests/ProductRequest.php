...
class ProductRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'thumbnail_img.required'    => translate('The thumbnail image is required'),
            'thumbnail_img.dimensions' => translate('The thumbnail image must be at least 195x195 pixels.'),
