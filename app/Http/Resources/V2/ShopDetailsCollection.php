...
class ShopDetailsCollection extends JsonResource
{
    public function toArray($request)
    {
        ...
        [
            ...
            'delivery_pickup_latitude' => $this->delivery_pickup_latitude !== null ? $this->delivery_pickup_latitude : 0.00,
            'delivery_pickup_longitude' => $this->delivery_pickup_longitude !== null ? $this->delivery_pickup_longitude : 0.00,
