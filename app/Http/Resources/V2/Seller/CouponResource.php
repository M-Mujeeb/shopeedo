...
class CouponResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        if($this->type == 'product_base') {
            ...
            $decoded_product = Arr::pluck(json_decode($this->details, true), 'product_id');
    $products = Product::whereIn('id', $decoded_product)->get(); // Skip filter_products for testing
       ...
       // dd(json_encode(new ProductCollection($products)));
        return [
            ...
            // 'details' => ($this->type == 'product_base') ?( new ProductCollection($products)) : $this->details,
